    ...
    return (
        <section className='relative'>
            ...
            <div className='container absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2'>
                <div className=''>
                    <h2 className='text-xl md:text-4xl font-bold mb-4 text-white text-center animate-fadeindown'>Welcome to <span className='text-lime-300 animate-pulse'>VarianPlus</span></h2>
